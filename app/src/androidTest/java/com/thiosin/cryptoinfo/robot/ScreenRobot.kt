package com.thiosin.cryptoinfo.robot
...
abstract class ScreenRobot<T : ScreenRobot<T>>(protected val espressoTest: EspressoTest<*>) {
    ...
    protected fun checkRecyclerViewItemHasText(@IdRes viewId: Int, itemPosition: Int, @StringRes textResId: Int) =
        applyActions {
    ...
    protected fun clickViewInRecyclerViewItem(@IdRes viewId: Int, itemPosition: Int, @IdRes viewInItemId: Int) =
        applyActions {
